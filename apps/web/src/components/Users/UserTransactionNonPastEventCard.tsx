...
export default function UserTransactionsNonPastEventCard({ banner, eventName, transactionCreatedAt, transactionTotalAmount, transactionDiscount, codeUsed, userEmail, eventId }: IUserTransactionsCard) {
    ...
    return (
        <div className="card bg-white p-[10px] shadow-2xl flex flex-col lg:flex-none mx-10 md:mx-20 lg:mx-52 rounded-lg">
            ...
            <div className="card-details flex flex-col justify-between">
                ...
                <div className="bottom mx-4 flex justify-between text-sky-600">
