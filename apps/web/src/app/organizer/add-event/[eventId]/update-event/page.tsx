                    ...
                    <div className="card w-full bg-gray-300 text-primary-content shadow-2xl hover:shadow-[#d8ecff]">
                        <div className="card-body">
                            {dataEventDetails ? (
                                <Formik
                                    initialValues={{
                                        name: dataEventDetails?.name,
                                        date: dataEventDetails?.date,
                                        startTime: dataEventDetails?.startTime,
                                        endTime: dataEventDetails?.endTime,
                                        description: dataEventDetails?.description,
                                        termsAndConditions: dataEventDetails?.termsAndConditions,
                                        locationId: dataEventDetails?.locationId,
                                        categoryId: dataEventDetails?.categoryId,
